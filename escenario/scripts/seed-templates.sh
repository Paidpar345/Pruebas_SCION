...
for n in \
  ...
  "$SCENARIO_DIR/ISD4/AS410" "$SCENARIO_DIR/ISD4/AS411"
do
  seed_core "$n"
done
...
for n in \
  ...
  "$SCENARIO_DIR/ISD4/AS412" "$SCENARIO_DIR/ISD4/AS413" "$SCENARIO_DIR/ISD4/AS414"
do
  seed_leaf "$n"
done
...
for n in \
  ...
  "$SCENARIO_DIR/ISD4/HostA" "$SCENARIO_DIR/ISD4/HostB"
do
  seed_host "$n"
done
